...
public class DynamicConfigBinder {
    ...
    private Binder getBinder() {
        if (this.binder == null) {
            synchronized (this) {
                if (this.binder == null) {
                    this.binder = new Binder(getConfigurationPropertySource(),
                            getPropertySourcesPlaceholderResolver(),
     ...
     * @return
     */
    private PropertySourcesPlaceholdersResolver getPropertySourcesPlaceholderResolver() {
