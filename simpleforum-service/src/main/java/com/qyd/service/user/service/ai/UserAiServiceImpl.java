package com.qyd.service.user.service.ai;
...
import com.qyd.service.user.repository.dao.UserAiHistoryDao;
import com.qyd.service.user.repository.entity.UserAiDO;
import com.qyd.service.user.repository.entity.UserAiHistoryDO;
...
public class UserAiServiceImpl implements UserAiService {
    ...
    public int getMaxChatCnt(Long userId) {
        ...
        if (ai.getInviteNum() > 0) {
            cnt += ai.getInviteNum() * ((int) (cnt * aiConfig.getMaxNum().getInviteNum()));
        }
