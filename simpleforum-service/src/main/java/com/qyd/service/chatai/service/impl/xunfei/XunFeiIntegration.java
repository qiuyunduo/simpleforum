package com.qyd.service.chatai.service.impl.xunfei;
...
public class XunFeiIntegration {
    ...
    public String buildXunFeiUrl() {
        try {
            String authUrl = getAuthorizationUrl(xunFeiConfig.hostUrl, xunFeiConfig.getApiKey(), xunFeiConfig.getApiSecret());
    ...
    @Data
    @Component
    @ConfigurationProperties(prefix = "xun-fei")
    public static class XunFeiConfig {
        public String hostUrl = "http://spark-api.xf-yun.com/v1.1/chat";
        public String appId = "";
        public String apiKey = "";
        public String apiSecret = "";
        // 指定访问的领域，general指向V1.5版本 generalV2指向V2版本。 注意不同的取值对应的url也是不一样的
    ...
    public static class Header {
        ...
        /**
         * 错误码： 0表示正常，非0表示出错，详细解释可在接口说明文档最后的错误码说明了解
         */
        private int code;
    ...
    public static class Choices {
        ...
        /**
         * 文本响应状态，取值[0,1,2]； 0代表首个文本结果 1代表中间文本结果， 2 代表最后一个文本结果
         */
        private int status;
        ...
        private List<ChoiceText> text;
    }

    @Data
    public static class ChoiceText {
        /**
         * 结果序号， 取值[0,10]; 当前为保留字段，开发这可忽略
         */
        private int index;
    ...
    public static class UsageText {
        ...
        /**
         * prompt_tokens 和 completion_tokens的和， 也是本次交互计费的tokens大小
         */
